...
import { addOneRental_POST_user, fetchAllRentalsOfUser_GET_user, fetchLastRentalOfCar_GET_user, returnCar_POST_user, fetchOneRental_GET_user, fetchAllRentalsWithFilters_GET_user, fetchAllPendingRentals_GET_user} from '../controllers/rentalsController';
