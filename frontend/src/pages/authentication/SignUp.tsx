...
const SignUp = () => {
  useEffect(() => {
    document.title = `Rejestracja | NP-CARS`;
  }, []);
          ...
          {pageState !== PageStatus.Success ? (
            <div className="w-full border-stroke dark:border-strokedark xl:w-3/5 xl:border-l-2">
              <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                <span className="mb-1.5 block font-medium text-center xl:text-left">
                  Zarządzanie samochodami jeszcze nigdy nie było tak proste!
                </span>
                ...
                <form onSubmit={submitHandler}>
                  ...
                  <div className="mb-5">
                    <p>
                      Uwaga! Po zarejestrowaniu się Twoje konto nadal pozostanie
                      niekatywne do czasu jego potwierdzenia przez
            ...
            <div className="w-full border-stroke dark:border-strokedark xl:w-3/5 xl:border-l-2">
              <OperationResult
                ...
                description="Konto zostało utworzone. Pamiętaj, że będziesz mógł z niego korzystać dopiero po zatwierdzeniu przez administratora."
                showButton={false}
              />
              <div className="mt-6 text-center">
                <p>
