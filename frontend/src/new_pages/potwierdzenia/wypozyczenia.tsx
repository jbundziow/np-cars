    ...
    useEffect(() => {
      const getData = async () => {  
        ...
        if(res1.status === 'success') {
          const res2 = await fetchData(`${DOMAIN_NAME}/rentals?filters=%7B%22carIDs%22%3A%5B%5D%2C%22userIDs%22%3A%5B%5D%2C%22returnUserIDs%22%3A%5B%5D%2C%22placeIDs%22%3A%5B%5D%2C%22editedByModerator%22%3Afalse%2C%22carMileageBefore_from%22%3A%22%22%2C%22carMileageBefore_to%22%3A%22%22%2C%22carMileageAfter_from%22%3A1%2C%22carMileageAfter_to%22%3A%22%22%2C%22distance_from%22%3A%22%22%2C%22distance_to%22%3A%22%22%2C%22travelDestination%22%3A%22%22%7D&pagenumber=${currentPage}&pagesize=8&sortfromoldest=false`, (arg:ApiResponse)=>{setFailData(arg)}, (arg:boolean)=>{setFail(arg)}, (arg:boolean)=>{setError(arg)}) //where editedByModerator = false(null) && carMileageAfter >= 1
