...
const MakeARentalAdminForm = (props: Props) => {
    ...
    useEffect(() => {
      ...
      const res1 = await fetchData(`${DOMAIN_NAME}/places?filters=%7B%7D&pagenumber=1&pagesize=999999`, (arg:ApiResponse)=>{setFailData(arg)}, (arg:boolean)=>{setFail(arg)}, (arg:boolean)=>{setError(arg)})
      setData1(res1);
