  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink
          onClick={()=> setSidebarOpen(false)} to="/">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Do potwierdzenia--> */}
              {auth.userRole === 'admin' ?
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/potwierdzenia' || pathname.includes('potwierdzenia')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === '/potwierdzenia' ||
                            pathname.includes('potwierdzenia')) &&
                          'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink
                              onClick={()=> setSidebarOpen(false)}
                              to="/potwierdzenia/tankowania"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
                              Tankowania użytkowników
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
                              onClick={()=> setSidebarOpen(false)}
                              to="/potwierdzenia/tankowania/zwrot-pieniedzy"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
                              Zwrot pieniędzy za tankowania
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
                              onClick={()=> setSidebarOpen(false)}
                              to="/potwierdzenia/usterki"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                                ...
                                >
                                  <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                    ...
                                    <li>
                                      <NavLink
                                        onClick={()=> setSidebarOpen(false)}
                                        to="/rezerwacje/przyszle-rezerwacje"
                                        className={({ isActive }) =>
                                          'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                          (isActive && '!text-white')
                                        }
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            ...
                            >
                              Kody PIN do kart paliwowych
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
                              onClick={()=> setSidebarOpen(false)}
                              to="/tankowania/moje-tankowania"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
              ...
              {/* <!-- Menu Item Użytkownicy--> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/uzytkownicy' || pathname.includes('uzytkownicy')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === '/uzytkownicy' ||
                            pathname.includes('uzytkownicy')) &&
                          'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/samochody' || pathname.includes('samochody')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/projekty' || pathname.includes('projekty')
                }
              >
                {(handleClick, open) => {
                  return (
          ...
          {/* <!-- @@@@REMOVE LATER @@@@@@ Menu Group --> */}
          <div>
            <h3 className="mb-4 ml-4 text-sm font-semibold text-bodydark2">
              MENU TO DELETE LATER
            </h3>
