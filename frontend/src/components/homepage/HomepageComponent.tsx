...
import { db_User } from "../../types/db_types.ts";
...
const HomepageComponent = (props: HomepageComponentProps) => {
    ...
    return (
        <>
        <h2 className="text-title-md2 font-semibold text-black dark:text-white mt-3 mb-3">Cześć {props.userData.name},</h2>
        ...
        <div className="bg-white dark:bg-boxdark rounded-lg px-6 py-10">
