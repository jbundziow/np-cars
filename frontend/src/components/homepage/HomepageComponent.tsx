...
const HomepageComponent = (props: HomepageComponentProps) => {
    ...
    return (
        ...
        <div className="flex flex-col-reverse md:flex-col">
            ...
            <div>
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5 mx-2 mt-10 md:mt-0">
            ...
            <div>
                <h2 className="text-title-md font-semibold text-black dark:text-white mt-10 mb-2 hidden md:block">Panel szybkiego dostępu:</h2>
                <div className="bg-white dark:bg-boxdark rounded-lg px-6 py-10 mx-2 mt-6 md:mt-0">

                <div className="flex flex-row flex-wrap justify-around gap-2">
                    <div className="flex justify-center my-4">
                        <Link
                        to={`/wypozyczenia/wypozycz-samochod`}
                        className="min-[340px]:min-w-[220px] text-center rounded-lg bg-primary py-4 px-6 font-medium text-gray hover:bg-opacity-70"
                        >
                        Wypożycz samochód
                        </Link>
                    </div>
                ...
                <div className="flex flex-row flex-wrap justify-around gap-2">
                    ...
                    <div className="flex justify-center my-4">
                        ...
                        className="min-[340px]:min-w-[220px] text-center text-white rounded-lg bg-meta-3 py-4 px-6 font-medium text-gray hover:bg-opacity-70"
                        >
