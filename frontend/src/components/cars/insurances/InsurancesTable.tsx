...
type InsurancesTableProps = {
  allCarsData: db_Car[] | [],
}


const InsurancesTable = (props: InsurancesTableProps) => {
        ...
        <div className="max-w-full overflow-x-auto">
          <table className="w-full table-auto">
            ...
            <div className='py-2' />
               ...
               {/* INSERT ROWS HERE */}
               {props.allCarsData
               .sort((a, b) => new Date(a.nextInsuranceDate).getTime() - new Date(b.nextInsuranceDate).getTime())
               .map(car => <InsurancesTableRow carData={car} />)
               }
