            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border-b border-[#eee] py-5 px-2 dark:border-strokedark">
                  ...
                  <Link
                    to="#"
                    className="inline-flex items-center justify-center rounded-full bg-primary py-2 px-7 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
                    >
                    Wypożycz
                    </Link>
                  </div>
