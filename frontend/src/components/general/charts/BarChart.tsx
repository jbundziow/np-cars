...
const BarChart = (props: BarChartProps) => {
  ...
  const generateOptionsData = (filterBy: 'year' | 'month'): {value: number, text: string}[] => {
    if(filterBy === 'month') return [
      { value: 0, text: 'Styczeń' },
      { value: 1, text: 'Luty' },
      { value: 2, text: 'Marzec' },
      { value: 3, text: 'Kwiecień' },
      { value: 4, text: 'Maj' },
      { value: 5, text: 'Czerwiec' },
      { value: 6, text: 'Lipiec' },
      { value: 7, text: 'Sierpień' },
      { value: 8, text: 'Wrzesień' },
      { value: 9, text: 'Październik' },
      { value: 10, text: 'Listopad' },
      { value: 11, text: 'Grudzień' }
      ];
      ...
      for (let i = 0; i < 5; i++) {
        years.push({value: currentYear - i, text: (currentYear - i).toString()});
      }
      return years;
    }
  }
  ...
  return (
    <div className="col-span-12 rounded-md border border-stroke bg-white px-5 pt-7.5 pb-5 shadow-default dark:border-strokedark dark:bg-boxdark-2 sm:px-7.5">
